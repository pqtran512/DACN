...
import { Button, Card2, Datepicker, SelectInput } from '../../components';
                    ...
                    <div className="flex w-full">
                        <div className="hidden xl:grid w-1/3 pr-6 gap-4 h-fit">
                            ...
                            <div>
                                ...
                                <SelectInput style='w-full' placeholder='--- Chọn điểm đi ---'/>
                            </div>
                            <div>
                                <div className="pt-[10px] pb-[14px] pr-[10px]">
                                    <div className="text-title-1 font-semibold text-neutral-1-900">Điểm đến</div>
                                </div>
                                <SelectInput style='w-full' placeholder='--- Chọn điểm đến ---'/>
                            </div>
                            <div>
                                <div className="pt-[10px] pb-[14px] pr-[10px]">
                            ...
                            <div className="py-4">
                                <input 
                                    className="w-full cursor-pointer" type="range" min="600000" max="5000000" step="50000" 
                                    value={rangeValue} 
                                    onChange={(e)=>setRangeValue(e.target.value)}
                                />
                                <div className="pt-2 text-body-2 flex justify-between items-center">
                                    <div id="range-value" className="text-black">{(rangeValue === 0)? 'Từ 600.000đ - 50.000.000đ' : rangeValue}</div>
                            ...
                            <div>
                                ...
                                <div className="flex justify-center">
                                    <div className="grid gap-6 grid-cols-btn text-body-1 text-neutral-1-900">
                                        <button 
                                            className={`${isTourTypeBtnActive('vehicleBtn1') ? 'activeBtn' : 'hover:bg-neutral-3-50'} py-2 rounded-[6px] shadow-btn`}
                                            onClick={() => handleTourTypeBtn('vehicleBtn1')}>Ô tô</button>
                                        <button 
                                            className={`${isTourTypeBtnActive('vehicleBtn2') ? 'activeBtn' : 'hover:bg-neutral-3-50'} py-2 rounded-[6px] shadow-btn`}
                                            onClick={() => handleTourTypeBtn('vehicleBtn2')}>Xe khách</button>
                                        <button 
                                            className={`${isTourTypeBtnActive('vehicleBtn3') ? 'activeBtn' : 'hover:bg-neutral-3-50'} py-2 rounded-[6px] shadow-btn`}
                                            onClick={() => handleTourTypeBtn('vehicleBtn3')}>Máy bay</button>
                                    </div>
                                </div>
                            </div>
                            <Button text='Tìm kiếm' textColor='text-white' bgColor='bg-primary-1' mt/>
                        </div>
                        <div className="w-full xl:w-2/3">
                                ...
                                <div className="md:flex items-center justify-between">
                                    <div className="md:flex items-center">
                                        ...
                                        <div className="w-full flex justify-between items-center md:w-fit">
                                            <SelectInput style='h-fit w-48 xl:w-[200px]' options={orderOpts} placeholder='Được đề xuất'/>
                            ...
                            <div className="pt-6 grid gap-y-6 md:grid-cols-2 md:gap-x-6 md:gap-y-8 xl:py-8">
                                ...
                                <Card2 img='../img/home/sec2-img1.png' location='Thành phố Hạ Long' price1='11,500,000đ' price2='10,500,000đ' id='HCMPQ4N4D_0512' time='3 ngày 2 đêm' animation='md:animate-fade-right'/>
                                <Card2 img='../img/home/sec2-img2.png' location='Thành phố Hạ Long' price1='11,500,000đ' price2='10,500,000đ' id='HCMPQ4N4D_0512' time='3 ngày 2 đêm' animation='md:animate-fade-left'/>
                                <Card2 img='../img/home/sec2-img1.png' location='Thành phố Hạ Long' price1='11,500,000đ' price2='10,500,000đ' id='HCMPQ4N4D_0512' time='3 ngày 2 đêm' animation='md:animate-fade-right'/>
                                
                                <Card2 hidden='hidden md:block' img='../img/home/sec2-img2.png' location='Thành phố Hạ Long' price1='11,500,000đ' price2='10,500,000đ' id='HCMPQ4N4D_0512' time='3 ngày 2 đêm' animation='md:animate-fade-left'/>
                                <Card2 hidden='hidden md:block' img='../img/home/sec2-img1.png' location='Thành phố Hạ Long' price1='11,500,000đ' price2='10,500,000đ' id='HCMPQ4N4D_0512' time='3 ngày 2 đêm' animation='md:animate-fade-right'/>
                                <Card2 hidden='hidden md:block' img='../img/home/sec2-img2.png' location='Thành phố Hạ Long' price1='11,500,000đ' price2='10,500,000đ' id='HCMPQ4N4D_0512' time='3 ngày 2 đêm' animation='md:animate-fade-left'/>
                                <Card2 hidden='hidden md:block' img='../img/home/sec2-img1.png' location='Thành phố Hạ Long' price1='11,500,000đ' price2='10,500,000đ' id='HCMPQ4N4D_0512' time='3 ngày 2 đêm' animation='md:animate-fade-right'/>
                                <Card2 hidden='hidden md:block' img='../img/home/sec2-img2.png' location='Thành phố Hạ Long' price1='11,500,000đ' price2='10,500,000đ' id='HCMPQ4N4D_0512' time='3 ngày 2 đêm' animation='md:animate-fade-left'/>
                            </div>
                            <div className="pt-6 w-full flex items-center justify-center xl:hidden">
                                <a href="danhsachtour.html" className="py-3 px-8 text-button1 font-semibold text-neutral-1-900 border-[2px] border-primary-2 rounded-[99px] shadow-shad1">Xem thêm</a>
                            </div>
                             {/* Pagination  */}
                            <ul className="hidden xl:flex items-center justify-end gap-2">
                                <li><div className="flex items-center justify-center w-10 h-10 rounded-[4px] text-[14px] leading-[22px] bg-neutral-1-300 text-primary-2 transition-all group hover:bg-white hover:text-white hover:font-semibold">
                                    <a href="#" className="flex items-center justify-center w-[38px] h-[38px] rounded-[4px] bg-neutral-1-300 transition-all group-hover:bg-primary-2">1</a></div>
                                </li>
                                <li><div className="flex items-center justify-center w-10 h-10 rounded-[4px] text-[14px] leading-[22px] bg-neutral-1-300 text-primary-2 transition-all group hover:bg-white hover:text-white hover:font-semibold">
                                    <a href="#" className="flex items-center justify-center w-[38px] h-[38px] rounded-[4px] bg-neutral-1-300 transition-all group-hover:bg-primary-2">2</a></div>
                                </li>
                                <li><div className="flex items-center justify-center w-10 h-10 rounded-[4px] text-[14px] leading-[22px] bg-neutral-1-300 text-primary-2 transition-all group hover:bg-white hover:text-white hover:font-semibold">
                                    <a href="#" className="flex items-center justify-center w-[38px] h-[38px] rounded-[4px] bg-neutral-1-300 transition-all group-hover:bg-primary-2"><i className="twi-22-chevron-line text-[12px] text-center group-hover:font-semibold"></i></a>
                                    </div>
                                </li>
                            </ul>
                        </div>
